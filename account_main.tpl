...
<tr>
 <td><img src="images/acc.jpg" width="40%"><h2>Welcome Member:</h2></td>
 <td><h2><font color="green">{$userinfo.username}!</font></h2></td>
</tr><tr>
 ...
 <td valign=top><h2><font color="green">Account Balance:</font></h2></td>
 <td><h2><font color="green">{$currency_sign}<b>{$ab_formated.total}</b></font></h2><br>
 <small>
...
{/section}
 ...
 <td><font color="red">Pending Withdrawal:</font></td>
 <td><font color="red">{$currency_sign}<b>{$ab_formated.withdraw_pending}</b></font></td>
</tr><tr>
